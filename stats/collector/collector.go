...
func (c *collectorStub) SetTotalFlipsBasicReward(amount *big.Int, share *big.Int) {
	// do nothing
}
...
func SetTotalFlipsBasicReward(c StatsCollector, amount *big.Int, share *big.Int) {
	...
	c.SetTotalFlipsBasicReward(amount, share)
}

func (c *collectorStub) SetTotalFlipsExtraReward(amount *big.Int, share *big.Int) {
	// do nothing
}
...
func SetTotalFlipsExtraReward(c StatsCollector, amount *big.Int, share *big.Int) {
	...
	c.SetTotalFlipsExtraReward(amount, share)
}
...
func (c *collectorStub) AddFlipsBasicReward(balanceDest, stakeDest common.Address, balance, stake *big.Int, flipsToReward []*types.FlipToReward) {
	// do nothing
}
...
func AddFlipsBasicReward(c StatsCollector, balanceDest, stakeDest common.Address, balance, stake *big.Int, flipsToReward []*types.FlipToReward) {
	...
	c.AddFlipsBasicReward(balanceDest, stakeDest, balance, stake, flipsToReward)
}

func (c *collectorStub) AddFlipsExtraReward(balanceDest, stakeDest common.Address, balance, stake *big.Int, flipsToReward []*types.FlipToReward) {
	// do nothing
}
...
func AddFlipsExtraReward(c StatsCollector, balanceDest, stakeDest common.Address, balance, stake *big.Int, flipsToReward []*types.FlipToReward) {
	...
	c.AddFlipsExtraReward(balanceDest, stakeDest, balance, stake, flipsToReward)
}
...
func (c *collectorStub) AddInviteeReward(addr common.Address, stake *big.Int, age uint16, txHash common.Hash, epochHeight uint32) {
	// do nothing
}
...
func AddInviteeReward(c StatsCollector, addr common.Address, stake *big.Int, age uint16, txHash common.Hash, epochHeight uint32) {
	...
	c.AddInviteeReward(addr, stake, age, txHash, epochHeight)
}
...
func (c *collectorStub) AddNonValidatedStake(addr common.Address, amount *big.Int) {
	// do nothing
}
...
func AddOracleVotingDeploy(c StatsCollector, contractAddress common.Address, startTime uint64,
	...
	c.AddOracleVotingDeploy(contractAddress, startTime, votingMinPayment, fact, state, votingDuration,
		publicVotingDuration, winnerThreshold, quorum, committeeSize, networkSize, ownerFee, ownerDeposit, oracleRewardFund, refundRecipient, hash)
}
...
func (c *collectorStub) AddOracleVotingCallProlongation(startBlock *uint64, epoch uint16, vrfSeed []byte, committeeSize, networkSize, newCommitteeSize uint64,
	newEpochWithoutGrowth *byte, newProlongVoteCount *uint64) {
	// do nothing
}
...
func AddOracleVotingCallProlongation(c StatsCollector, startBlock *uint64, epoch uint16, vrfSeed []byte, committeeSize, networkSize, newCommitteeSize uint64,
	...
	c.AddOracleVotingCallProlongation(startBlock, epoch, vrfSeed, committeeSize, networkSize, newCommitteeSize, newEpochWithoutGrowth, newProlongVoteCount)
}
