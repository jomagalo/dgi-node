...
import (
	...
	types2 "github.com/jomagalo/dgi-node/stats/types"
...
func TestQualification_qualifyFlips(t *testing.T) {
	...
	long0.Right(3)
	long0.Grade(3, types.GradeNone)
	long0.Right(4)
	long0.Grade(4, types.GradeNone)
